...
const u8 gText_MainMenuNewGame[] = _("重新开始");
const u8 gText_MainMenuContinue[] = _("继续旅程");
const u8 gText_MainMenuOption[] = _("游戏设置");
...
const u8 gText_ReturnToVar1[] = _("返回\n{STR_VAR_1}.");
...
const u8 gText_XNatureMetAtYZ[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05}的性格 ,\n{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}时在{SPECIAL_F7 0x00}{SPECIAL_F7 0x04}{SPECIAL_F7 0x01}遇见。");
...
const u8 gText_MenuOptionPokenav[] = _("导航仪");
