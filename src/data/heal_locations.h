static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(ATROPOS_KOHLRABI_GARDEN), MAP_NUM(ATROPOS_KOHLRABI_GARDEN), 7, 11},
    {MAP_GROUP(ATROPOS_QUITE_TOWN), MAP_NUM(ATROPOS_QUITE_TOWN), 0, 0},
    {MAP_GROUP(ATROPOS_GINKGO_CITY), MAP_NUM(ATROPOS_GINKGO_CITY), 0, 0},
    ...
    {MAP_GROUP(ATROPOS_PLATINIUM_CITY), MAP_NUM(ATROPOS_PLATINIUM_CITY), 0, 0},
    {MAP_GROUP(ATROPOS_HUPER_TOWN), MAP_NUM(ATROPOS_HUPER_TOWN), 0, 0},
    {MAP_GROUP(ATROPOS_DAVIDIA_CITY), MAP_NUM(ATROPOS_DAVIDIA_CITY), 9, 9},
