...
/* ************************************************ ***********
 * DNS filters are current 15bit RGB colors.
...
void DNS_System (void * src, void * dest)
{
    ...
    // If Player is in a regular menu DMA transfer will be used
...
{
    u16 network; u16 red; u16 green; u16 blue;
